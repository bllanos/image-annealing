// Texel format matches `<PermutationTexture as TextureDatatype>::format()` in src/compute/resource/texture/mod.rs
[[group(0), binding(0)]]
...
fn main([[builtin(global_invocation_id)]] global_id: vec3<u32>) {
    textureStore(output_permutation, vec2<i32>(global_id.xy), vec4<u32>(0, 0, 0, 0))
}